						...
						<div class="card mb-5 mb-xxl-8">
							...
							<div class="card-body pb-0">
								...
								<div class="">
									...
									<div class="d-flex align-items-center pb-4">
										...
										<div class="symbol symbol-45px symbol-light me-5">
											<span class="symbol-label align-items-end">
												<img alt="Logo" src="/src/assets/media/svg/avatars/018-girl-9.svg"
													class="mh-40px" />
											</span>
										</div>
										<!--end::Symbol-->
										...
										<div class="d-flex flex-column flex-grow-1">
											<a href="#"
												class="text-gray-800 text-hover-primary mb-1 fs-6 fw-bolder">Grace
												Logan</a>
										...
										<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold w-200px"
											...
											<div class="menu-item px-3">
												<div class="menu-content fs-6 text-dark fw-bolder px-3 py-4">Manage
												</div>
											</div>
											...
											<div class="menu-item px-3">
												<div class="menu-content px-3 py-3">
													<a class="btn btn-primary fw-bold btn-sm px-4" href="#">Create
														New</a>
												</div>
											</div>
										</div>
									...
									<div>
										<!--begin::Text-->
										<p class="text-gray-800 fs-6 fw-normal">What are Components of Computational
											Thinking?</p>
										<!--end::Text-->
										<!--begin::Action-->
										<div class="d-flex align-items-center">
											<a href="#"
												class="btn btn-sm btn-color-muted btn-active-light-primary fw-bolder">
												...
												<!--end::Svg Icon-->2</a>
											<a href="#"
												class="btn btn-sm btn-color-muted btn-active-light-danger fw-bolder">
										...
										<div class="d-flex py-5">
											...
											<div class="symbol symbol-40px me-5">
												<span class="symbol-label bg-light align-items-end">
													<img alt="Logo" src="/src/assets/media/svg/avatars/009-boy-4.svg"
														class="mh-35px" />
												</span>
											</div>
											<!--end::Symbol-->
											...
											<div class="d-flex flex-column flex-row-fluid">
												...
												<div class="d-flex align-items-center flex-wrap">
													<a href="#"
														class="text-gray-800 text-hover-primary mb-1 fs-6 fw-bolder pe-6">Mr.
														Anderson</a>
...
Example: Noticing that a sorting problem can be approached with the same algorithm used for another similar dataset.

3. Abstraction:
Focusing on the important information only, and ignoring irrelevant detail.
Example: Creating a model or representation of a real-world problem that captures its essential features while omitting unnecessary details.

4. Algorithm Design:
Developing a step-by-step solution to the problem or a set of rules to follow in order to solve the problem.
Example: Writing a procedure or code that systematically addresses each aspect of the problem.
                                  </pre>
												</span>
												<!--end::Info-->
											</div>
										...
										<div class="d-flex">
											...
											<div class="symbol symbol-40px me-5">
												<span class="symbol-label bg-light align-items-end">
													<img alt="Logo" src="/src/assets/media/svg/avatars/003-girl-1.svg"
														class="mh-35px" />
												</span>
											</div>
											<!--end::Symbol-->
											...
											<div class="d-flex flex-column flex-row-fluid">
												...
												<div class="d-flex align-items-center flex-wrap">
													<a href="#"
														class="text-gray-800 text-hover-primary mb-1 fs-6 fw-bolder pe-6">Mrs.
														Anderson</a>
													<span class="text-muted fw-normal flex-grow-1 fs-7">2 Days
														ago</span>
													<!-- <a href="#" class="text-muted text-hover-primary fw-normal fs-7">Reply</a> -->
												</div>
												<span class="text-gray-800 fs-7 fw-normal pt-1">
													Developing Computational Thinking Skills by Practice Coding,
													Engage in Problem-Solving Activities, Collaborate with Others, Learn
													and Use Computational Tools.

													Utilizing tools and software designed to aid in computational tasks,
													such as spreadsheets, databases, and programming languages.
						...
						<div class="card mb-5 mb-xxl-8">
							...
							<div class="card-body pb-0">
								...
								<div class="d-flex align-items-center">
									...
									<!--begin::Info-->
									<div class="d-flex flex-column flex-grow-1">
										<a href="#" class="text-gray-800 text-hover-primary mb-1 fs-6 fw-bolder">Grace
											Logan</a>
										<span class="text-muted fw-bold">Yestarday at 5:06 PM</span>
									</div>
									<!--end::Info-->
								...
								<div class="pt-5">
									...
									<p class="text-gray-800 fs-6 fw-normal mb-2">Outlines keep you honest. They stop you
										from indulging in poorly thought-out metaphors about driving and keep you
								...
								<div class="d-flex align-items-center flex-nowrap text-nowrap overflow-auto py-1">
									<a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal"
										data-bs-target="#kt_modal_select_location">Submit Your Answer </a>
								</div>
						...
						<div class="card mb-5 mb-xxl-8">
							...
							<div class="card-body pb-0">
								...
								<div class="d-flex align-items-center">
									...
									<div class="symbol symbol-45px me-5">
										<span class="symbol-label bg-light align-items-end">
											<img alt="Logo" src="/src/assets/media/svg/avatars/047-girl-25.svg"
												class="mh-40px" />
										</span>
									</div>
									<!--end::Symbol-->
									<!--begin::Info-->
									<div class="d-flex flex-column flex-grow-1">
										<a href="#" class="text-gray-800 text-hover-primary mb-1 fs-6 fw-bolder">Ruby
											Liam</a>
										<span class="text-muted fw-bold">Yestarday at 5:06 PM</span>
									</div>
									<!--end::Info-->
									...
									<div class="dropdown dropdown-inline">
										<button type="button"
											...
											<!--begin::Svg Icon | path: icons/duotone/Text/Dots.svg-->
										...
										<div class="dropdown-menu dropdown-menu-end w-md-325px p-0 m-0">
											...
											<div class="menu menu-sub menu-sub-dropdown menu-column w-300px w-lg-350px p-5"
												...
												<!--begin::Tabs-->
												<ul
													class="nav nav-line-tabs nav-line-tabs-2x border-light fw-bold mb-5">
													<li class="nav-item">
														...
														<ul
															...
															<li class="menu-item py-1">
																<a href="#" class="menu-link px-3">
																	...
																	<span class="menu-title">Activity and
																		Timeline</span>
																	<span
																		class="menu-badge badge badge-light-danger fw-bold">new</span>
																</a>
															</li>
															<li class="menu-item py-1">
																<a href="#" class="menu-link px-3">
															...
															<li class="menu-item py-1">
																<a href="#" class="menu-link px-3">
																	...
																	<span class="menu-title">Accessibility
																		Settings</span>
																</a>
															</li>
															<li class="menu-item py-1">
															...
															<li class="menu-item py-1">
																<a href="#" class="menu-link active px-3">
																	...
																	<span class="menu-title">Activity and
																		Timeline</span>
																	<span
																		class="menu-badge badge badge-danger fw-bold">new</span>
																</a>
															</li>
															<li class="menu-item py-1">
																<a href="#" class="menu-link px-3">
								...
								<div class="pt-4">
									...
									<!--begin::Image-->
									<div class="bgi-no-repeat bgi-size-cover rounded min-h-250px" :style="styleObject">
									</div>
									<!--end::Image-->
									<!--begin::Text-->
									<p class="text-gray-800 fs-6 fw-normal pt-5 mb-2">Outlines keep you honest. They
										stop you from indulging in poorly thought-out metaphors about driving and keep
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Individual Question</h5>
								<!--begin::Close-->
							...
							<div class="modal-body">
								...
								<div class="card mb-0 mb-xxl-8">
									...
									<div class="card-body p-0">
										...
										<div class="">
											...
											<div class="d-flex align-items-center pb-4">
												...
												<div class="symbol symbol-45px symbol-light me-5">
													<span class="symbol-label align-items-end">
														<img alt="Logo"
															src="/src/assets/media/svg/avatars/018-girl-9.svg"
															class="mh-40px" />
													</span>
												</div>
												<!--end::Symbol-->
											...
											<div>
												<!--begin::Text-->
												<p class="text-gray-800 fs-6 fw-normal">Outlines keep you honest. They
													stop you from indulging in
													poorly thought-out metaphors about driving and keep you focused on
										...
										<form class="position-relative py-4 d-flex align-items-center pb-5">
											<textarea data-kt-autosize="true"
												class="form-control min-h-auto border-0 p-0 pe-10 resize-none" rows="3"
												placeholder="Reply3..."></textarea>
											<div class="position-absolute top-0 end-0 mt-2 me-n3">
												<span class="btn btn-icon btn-sm btn-active-color-primary">
													<i class="fas fa-paperclip fs-6"></i>
												</span>
							...
							<div class="modal-footer">
								...
								<button id="submit" type="button" class="btn btn-primary" data-bs-dismiss="modal">
									Apply
								</button>
							</div>
						</div>
