            ...
            <div class="card card-stretch mb-5 mb-xxl-8">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder text-dark fs-3">Add Tenant</span>
                ...
                <div class="card-body pt-2">
                    <form @submit.prevent="createTenant" id="frmUpload" method="post" enctype="multipart/form-data">
...
const createTenant = async () => {
    ...
    const response = await axios.post(`${import.meta.env.VITE_API_BACKEND_ENDPOINT_TENANTS}`, tenant.value, {
        headers: {
