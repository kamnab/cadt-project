	...
	<div class="card mb-5 mb-xxl-8" :style="activeSection == 0 ? { backgroundColor: '#F9F2E7' } : {}">
		...
		<div class="card-body">
			...
			<div class="d-flex align-items-center">
				...
				<!--begin::Title-->
				<div>
					<RouterLink @click="handleClick" :to="{ name: 'class-content', params: { id: selectedClass.id } }"
						class="fs-4 text-gray-800 text-hover-primary fw-bolder">Content and Materials</RouterLink>
	...
	<div class="card mb-5 mb-xxl-8" :style="activeSection == 1 ? { backgroundColor: '#F9F2E7' } : {}">
		...
		<div class="card-body">
			...
			<div class="d-flex align-items-center">
				...
				<!--begin::Title-->
				<div>
					<RouterLink @click="handleClick" :to="{ name: 'class-activity', params: { id: selectedClass.id } }"
